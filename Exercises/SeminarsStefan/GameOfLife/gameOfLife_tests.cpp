...
TEST_CASE( "Tick a universe" ) 
{
	...
	SECTION( "With a single alive cell" ) 
    {
	    ...
	    Universe emptyUniverse(nullptr, 0, 0);
...
TEST_CASE( "Spaceship" ) 
{
    ...
    game.tick();
    REQUIRE( game.getUniverse().isCellAlive(1, 0) );
    REQUIRE( game.getUniverse().isCellAlive(1, 2) );
    REQUIRE( game.getUniverse().isCellAlive(2, 1) );
    REQUIRE( game.getUniverse().isCellAlive(2, 2) );
    REQUIRE( game.getUniverse().isCellAlive(3, 1) );

    game.tick();
    REQUIRE( game.getUniverse().isCellAlive(1, 2) );
    REQUIRE( game.getUniverse().isCellAlive(2, 0) );
    REQUIRE( game.getUniverse().isCellAlive(1, 2) );
    REQUIRE( game.getUniverse().isCellAlive(3, 1) );
    REQUIRE( game.getUniverse().isCellAlive(3, 2) );

    game.tick();
    REQUIRE( game.getUniverse().isCellAlive(1, 1) );
    REQUIRE( game.getUniverse().isCellAlive(2, 2) );
    REQUIRE( game.getUniverse().isCellAlive(2, 3) );
    REQUIRE( game.getUniverse().isCellAlive(3, 1) );
    REQUIRE( game.getUniverse().isCellAlive(3, 2) );
    ...
    REQUIRE( game.getUniverse().isCellAlive(3, 1) );
    REQUIRE( game.getUniverse().isCellAlive(3, 2) );
    REQUIRE( game.getUniverse().isCellAlive(3, 3) );
}